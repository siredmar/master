...
In \refc{sec:TeilB_Hardware} ist der Lagenaufbau bereits angesprochen worden. Die Innenlagen sind, mit wenigen Ausnahmen, für die \code{Ground}, \code{+5 V} und \code{+3.3 V} reserviert. 
\begin{figure}[htbp]
        %\begin{center}
        \centering
        \begin{subfigure}[htp]{0.48\textwidth}
