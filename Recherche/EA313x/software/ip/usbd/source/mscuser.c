...
UNS_32 Offset;                  /* R/W Offset */
UNS_32 Length;                  /* R/W Length */

/* If it's a USB HS, the max packet is 512, if it's USB FS,
the max packet is 64. Use 512 for both HS and FS. */
ALIGNED(4) UNS_8  BulkBuf[MSC_HS_MAX_PACKET]; /* Bulk In/Out Buffer */
