@ECHO OFF
REM *********************************************************************
REM  $Id:: setenv.bat 3514 2010-05-19 16:43:44Z usb10132                $
...
REM	NXPMCU_WINBASE variable, except that it is uses Unix style path slashes.
REM --------------------------------------------------------------------
REM SET NXPMCU_SOFTWARE=%NXPMCU_WINBASE:\=/%
SET NXPMCU_SOFTWARE=%NXPMCU_WINBASE%
SET BSP=
SET CSP=
SET TOOL=
