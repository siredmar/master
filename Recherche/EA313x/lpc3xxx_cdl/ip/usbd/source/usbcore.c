...
ALIGNED(32) uint8_t  EP0Buf[USB_MAX_PACKET0];
...
__inline BOOL_32 USB_ReqSetClrFeature(uint32_t sc)
{
  uint32_t n, m;
    ...
    case REQUEST_TO_DEVICE:
      switch (SetupPacket.wValue.WB.H)
      {
        ...
        case USB_CONFIGURATION_DESCRIPTOR_TYPE:
          pD = (uint8_t *)USB_ConfigDescriptors[DevStatusFS2HS];
    ...
    case REQUEST_TO_INTERFACE:
      switch (SetupPacket.wValue.WB.H)
      {
        ...
        case HID_HID_DESCRIPTOR_TYPE:
          ...
          EP0Data.pData = (uint8_t *)USB_ConfigDescriptors[DevStatusFS2HS] + HID_DescOffset;
          len = HID_DESC_SIZE;
          break;
...
__inline BOOL_32 USB_ReqSetConfiguration(void)
{
  ...
  switch (SetupPacket.bmRequestType.BM.Recipient)
  {
    case REQUEST_TO_DEVICE:
      ...
      {
        pD = (USB_COMMON_DESCRIPTOR *)USB_ConfigDescriptors[DevStatusFS2HS];
        while (pD->bLength)
        {
