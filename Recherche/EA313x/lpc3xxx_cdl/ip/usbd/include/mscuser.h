...
#define MSC_MemorySize      ((uint32_t)(31 * 1024 * 1024)) //( BOOT_SECT_SIZE + FAT_SIZE + ROOT_DIR_SIZE + MAX_FILE_SZ ) 
...
extern const uint8_t DiskImage[MSC_ImageSize];  /* Initial fat table & MBR */
