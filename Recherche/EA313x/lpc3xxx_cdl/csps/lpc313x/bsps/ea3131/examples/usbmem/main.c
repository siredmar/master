/***********************************************************************
 * $Id:: main.c 6155 2011-01-12 05:00:32Z ing02124                     $
 *
 * Project: USB Mass Storage using Memory example
 *
 * Description:
 *     A simple USB Mass Storage example using Memory as storage.
 *
 ***********************************************************************
    ...
    if (uart_read(g_uart_id, &ch, 1) > 0)
    {
      ...
      switch (ch)
      {
        ...
        case 'Q':
          ...
          //end_adr = (volatile UNS_32*) (ep_QH + (EP_NUM_MAX * sizeof(DQH_T)));
          break;
        case 't':
        case 'T':
          /* dump usb queue */
          ...
          //end_adr = (volatile UNS_32*) (ep_TD + (EP_NUM_MAX * sizeof(DTD_T)));
          break;
        default:
          break;
      }
