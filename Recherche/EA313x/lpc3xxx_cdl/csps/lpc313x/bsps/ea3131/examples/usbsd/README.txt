1. Information about USB MSC class using SD card example:
=========================================================
The usbsd example demonstrates the USB Mass storage class capabilities of
LPC313X USB device controller using SD card memory as storage. 

Instructions to run the usbsd application:
===========================================
1. Build  usbsd example in CDL 
2. After build \software\csps\lpc313x\bsps\<bsp>\examples\usbsd\usbsd_demo.bin 
   should be created.
...
4. On PC launch terminal applications such as TeraTerm and download the 
   usbsd_demo.bin using binary download. 
