...
/* LPC3152 CODEC I2C address */
#define CODEC_I2C_ADDR (0x0C)
...
/***********************************************************************
 *
 * Function: lpc315x_start_playback
 *
 ...
 *
 **********************************************************************/
static void lpc315x_start_playback(void)
{
  INT_32 dmach;
  DMAC_REGS_T *dmaregs = dma_get_base();
...
/***********************************************************************
 *
 * Function: lpc315x_stop_playback
 *
 ...
 *
 **********************************************************************/
static void lpc315x_stop_playback(void)
{
  DMAC_REGS_T *dmaregs = dma_get_base();
...
/***********************************************************************
 *
 * Function: lpc315x_start_recording
 *
 ...
 *
 **********************************************************************/
static void lpc315x_start_recording(void)
{
  INT_32 dmach;
  DMAC_REGS_T *dmaregs = dma_get_base();
...
/***********************************************************************
 *
 * Function: lpc315x_stop_recording
 *
 ...
 *
 **********************************************************************/
static void lpc315x_stop_recording(void)
{
  DMAC_REGS_T *dmaregs = dma_get_base();
  recording.active = 0;
 ...
 *
 **********************************************************************/
static int lpc315x_audio_init(void)
{
  ...
  * (UNS_32 *) 0x130044dc = 5;
  ...
  /* Setup CODEC driver */
  if (lpc3152_codec_driver_init(i2cdev, CODEC_I2C_ADDR) < 0)
  {
    uart_string_write("LPC3152 CODEC init failed! \r\n");
    return 1;
  }
