/***********************************************************************
 * $Id:: lpc313x_dma_driver.h 8087 2011-09-14 04:13:00Z ing02124       $
 *
 ...
 * DMA driver types
 **********************************************************************/
typedef void (*PF_DMACB)(INT_32 , DMA_IRQ_TYPE_T, void *);
...
/* Allocate a channel for scatter gather DMA, use ch for selected channel
	 (0 to 7) or
   -1 to use the highest priority available channel. Also sets up the
   user callback functions for the channel's DMA interrupt.
   cb, data - Callback function & parameter for first DMA channel
   cb1, data1 - Callback function & parameter for second DMA channel
   softirq - Enable Soft IRQ
 */
...
/* Return (free) an allocated scatter gather DMA channel */
