/***********************************************************************
* $Id:: lpc313x_usbd_driver.h 6112 2011-01-11 04:41:10Z ing02124      $
*
...
typedef struct _USB_INIT_
{
  ...
  UNS_32(* USB_virt_to_phys)(void* vaddr);
  void (* USB_cache_flush)(UNS_32* start_adr, UNS_32* end_adr);
  void (* USB_cache_invalidate)(UNS_32* start_adr, UNS_32* end_adr);

  /* USB Endpoint Events Callback Pointers */
  void (* USB_P_EP[EP_NUM_MAX/2])(UNS_32 event);
