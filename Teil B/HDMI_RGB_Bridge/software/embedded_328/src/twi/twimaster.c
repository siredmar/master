...
/*************************************************************************
 Writes a data byte to a given address

 Input:  address of the eeprom to which the data should be written to
...
/*************************************************************************
 ...
 Input:  address of the eeprom from which the data should be read
