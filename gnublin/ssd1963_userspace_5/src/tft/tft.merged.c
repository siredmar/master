...
{
   if(tft_register_ui16 != 0x00)
   {
      tft_sendCommand(tft_register_ui16);
   }
   //usleep(10);
   if(tft_registerValue_ui16 != 0xFFFF)
   ...
   )
   {
      ...
      if(init == 1)
      {
         ...
         tft_setDisplayRegister(SSD1963_SET_PLL_MN, 0x0023);                            tft_waitXms(150);
         tft_setDisplayRegister(0, 0x23);                                               tft_waitXms(10);
         tft_setDisplayRegister(0, 0x2);                                                tft_waitXms(10);
         tft_setDisplayRegister(0, 0x4);                                                tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_PLL, 0x01);                                 tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_PLL, 0x03);                                 tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SOFT_RESET, 0xFFFF);                            tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_LSHIFT_FREQ, 0x03);                         tft_waitXms(10);
         tft_setDisplayRegister(0, 0x00FF);                                             tft_waitXms(10);
         tft_setDisplayRegister(0, 0x00FF);                                             tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_LCD_MODE, 0x27);                            tft_waitXms(10);
         tft_setDisplayRegister(0, 0x0000);                                             tft_waitXms(10);
         tft_setDisplayRegister(0, (HDP>>8)&0X00FF);                                    tft_waitXms(10);
         tft_setDisplayRegister(0, HDP&0X00FF);                                         tft_waitXms(10);
         tft_setDisplayRegister(0, (VDP>>8)&0X00FF);                                    tft_waitXms(10);
         tft_setDisplayRegister(0, VDP&0X00FF);                                         tft_waitXms(10);
         tft_setDisplayRegister(0, 0x0000);                                             tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_HORI_PERIOD, ((HT >> 8U) & 0x00FF));        tft_waitXms(10);
         tft_setDisplayRegister(0, (HT & 0x00FF));                                      tft_waitXms(10);
         tft_setDisplayRegister(0, ((HPS >> 8U) & 0x00FF));                             tft_waitXms(10);
         tft_setDisplayRegister(0, (HPS & 0x00FF));                                     tft_waitXms(10);
         tft_setDisplayRegister(0, HPW);                                                tft_waitXms(10);
         tft_setDisplayRegister(0, ((LPS >> 8U) & 0x00FF));                             tft_waitXms(10);
         tft_setDisplayRegister(0, (LPS & 0x00FF));                                     tft_waitXms(10);
         tft_setDisplayRegister(0, 0x0000);                                             tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_VERT_PERIOD, ((VT >> 8U) & 0x00FF));        tft_waitXms(10);
         tft_setDisplayRegister(0, (VT & 0x00FF));                                      tft_waitXms(10);
         tft_setDisplayRegister(0, (VPS >> 8U) & 0x00FF);                               tft_waitXms(10);
         tft_setDisplayRegister(0, (VPS & 0x00FF));                                     tft_waitXms(10);
         tft_setDisplayRegister(0, VPW);                                                tft_waitXms(10);
         tft_setDisplayRegister(0, ((FPS >> 8U) & 0x00FF));                             tft_waitXms(10);
         tft_setDisplayRegister(0, (FPS & 0x00FF));                                     tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_ADDRESS_MODE, 0x00);                        tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_PIXEL_DATA_INTERFACE, 0x03);                tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_DISPLAY_ON, 0xFFFF);                        tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_PWM_CONF, 0x06);                            tft_waitXms(10);
         tft_setDisplayRegister(0, 0x00F0);                                             tft_waitXms(10);
         tft_setDisplayRegister(0, 0x0001);                                             tft_waitXms(10);
         tft_setDisplayRegister(0, 0x00F0);                                             tft_waitXms(10);
         tft_setDisplayRegister(0, 0x0000);                                             tft_waitXms(10);
         tft_setDisplayRegister(0, 0x0000);                                             tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_DBC_CONF, 0x0D);                            tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_GPIO_CONF, 0x00);                           tft_waitXms(10);
         tft_setDisplayRegister(0, 0x0000);                                             tft_waitXms(10);
         tft_setDisplayRegister(SSD1963_SET_GPIO_VALUE, 0x00);                          tft_waitXms(10);
