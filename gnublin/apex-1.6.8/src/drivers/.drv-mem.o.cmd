cmd_src/drivers/drv-mem.o := arm-linux-gnueabi-gcc -Wp,-MD,src/drivers/.drv-mem.o.d  -nostdinc -isystem /opt/eldk-5.2.1/armv5te/sysroots/i686-eldk-linux/usr/lib/armv5te-linux-gnueabi/gcc/arm-linux-gnueabi/4.6.4/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -fno-builtin-printf -Os   -fno-stack-protector -D__LINUX_ARM_ARCH__=5 -march=armv5te -mtune=arm9tdmi -Wall -fomit-frame-pointer -g -Wdeclaration-after-statement -Wno-pointer-sign     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(drv_mem)"  -D"KBUILD_MODNAME=KBUILD_STR(drv_mem)" -c -o src/drivers/drv-mem.o src/drivers/drv-mem.c

deps_src/drivers/drv-mem.o := \
  src/drivers/drv-mem.c \
    $(wildcard include/config/mmu.h) \
    $(wildcard include/config/atag.h) \
    $(wildcard include/config/cmd/memlimit.h) \
    $(wildcard include/config/small.h) \
    $(wildcard include/config/cmd/memscan.h) \
  include/config.h \
...
src/drivers/drv-mem.o: $(deps_src/drivers/drv-mem.o)
