...
void tft_readSignature()
{
   ...
   printf("%i. Signature: 0x%.2X 0x%.2X 0x%.2X 0x%.2X 0x%.2X\n", cnt++, id[0], id[1], id[2], id[3], id[4]);
}
...
void tft_readPLL()
{
   ...
   tft_sendCommand(SSD1963_GET_PLL_MN);
//   tft_sendData(0x0023);
//   tft_sendData(0x0002);
//   tft_sendData(0x0004);
   ...
   printf("%i. GetPLLMN[0]: 0x%.2X\n", cnt, get_pll_mn[0]);
   printf("%i. GetPLLMN[1]: 0x%.2X\n", cnt, get_pll_mn[1]);
   printf("%i. GetPLLMN[2]: 0x%.2X\n", cnt, get_pll_mn[2]);
}
