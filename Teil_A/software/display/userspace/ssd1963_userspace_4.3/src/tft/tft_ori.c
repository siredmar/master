...
void *sram0_ctrl_map;
void *sram0_data_map;
volatile unsigned char *sram0_ctrl;
volatile unsigned char *sram0_data;
...
static Std_ReturnType tft_openSRAM0Memory()
{
   ...
   sram0_ctrl = (volatile unsigned char *)sram0_ctrl_map;
   ...
   // Always use volatile pointer!
   sram0_data = (volatile unsigned char *)sram0_data_map;
