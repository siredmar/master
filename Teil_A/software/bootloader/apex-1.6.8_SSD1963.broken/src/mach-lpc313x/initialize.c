...
//   MPMC_STWTTURN0 = 0;
   ...
   MPMC_DYTRP    = NS_TO_MPMCCLK(28, HCLK); // was 28 //2
   MPMC_DYTRAS   = NS_TO_MPMCCLK(44, HCLK); // was 44 //4
   MPMC_DYTSREX  = NS_TO_MPMCCLK(75, HCLK); // was 75 //7
   MPMC_DYTAPR   = 4;                       // was    //4
   MPMC_DYTDAL   = NS_TO_MPMCCLK(50, HCLK); // was 50 //5
   MPMC_DYTWR    = NS_TO_MPMCCLK(75, HCLK); // was 75 //7
   MPMC_DYTRC    = NS_TO_MPMCCLK(66, HCLK); // was 66 //6
   MPMC_DYTRFC   = NS_TO_MPMCCLK(66, HCLK); // was 66 //6
   MPMC_DYTXSR   = NS_TO_MPMCCLK(75, HCLK); // was 75 //7
   MPMC_DYTRRD   = NS_TO_MPMCCLK(15, HCLK); // was 15 //1
   MPMC_DYTMRD   = NS_TO_MPMCCLK(20, HCLK); // was 20 //2
